...
const translations: Record<Locale, Record<string, string>> = {
  ja: {
    ...
    'profile.report.title.two': '{{a}} × {{b}} リスナー',
    'profile.report.title.one': '{{a}} リスナー',
    'profile.report.title.none': 'ミュージックリスナー',
  ...
  en: {
    ...
    'profile.report.title.two': '{{a}} × {{b}} Listener',
    'profile.report.title.one': '{{a}} Listener',
    'profile.report.title.none': 'Music Listener',
